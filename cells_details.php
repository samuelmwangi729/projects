        ...
        <div class="col-lg-10">
          ...
          <div class="table-responsive" style="height:auto;">
            ...
            <table class="table table-bordered table-striped"style="color:#2C2D6E;font-family:cursive;font-weight:bold;">
              ...
              <tbody>
                <?php
                $sel_count="SELECT * FROM cells";
                $quer=mysqli_query($conn,$sel_count);
                $count=mysqli_num_rows($quer);
                $count=ceil($count/3);
                echo $count;
                $c="SELECT * FROM cells ORDER BY number ASC limit 0,3";
          ...
          <ul class="pagination justify-content-center">
            ...
            for($i=1;$i<=$count;$i++){
              echo "
                <li class='page-item'><a  class='page-link'  href='cell_details.php?view={$i}'>{$i}</a></l1>
              ";
            }
             ?>
          </ul>
