      ...
      <div class="col-lg-10 col-md-10 col-sm-10">
        <div class="container-fluid">
            ...
            <?php if(isset($_POST['sub'])){
              $case=$_POST['cno'];
              $off=$_POST['officer'];
              $sql="update cr set Investigator='$off' where cr_no='$case'";
              $qry=mysqli_query($conn,$sql);
              if($qry){
                echo "
                <div class='alert alert-success'id='alert'>
                <strong>Success</strong>&nbsp;Investigator  Added
                </div>";
              }else{
                echo "
                <div class='alert alert-danger'id='alert'>
                <strong>Error</strong>&nbsp;Investigator Not Added
                </div>";
              }
            }?>
        <form method="POST" action="<?php $_SERVER['PHP_SELF']?>" class="form" style="padding-top:10px;"></br></br>
          ...
          <div class="row">
            ...
            <div class="col-lg-6"><label for="Names" class="label-control" style="margin-top:35px">Select Officers</label>
