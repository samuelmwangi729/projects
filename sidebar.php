...
<ul class="list-group">
  ...
  <li class="list-group-item"><a href="officers.php">Officers</a></li>
  <li class="list-group-item"><a href="assign.php">Assign Cases</a></li>
  <li class="list-group-item"><a href="all.php">All Assualt Claims</a></li>
    <li class="list-group-item"><a href="add.php">Add Users</a></li>
</ul>
</div>
